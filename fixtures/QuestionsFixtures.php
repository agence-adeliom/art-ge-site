    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $questions = [
            ...
            "Eco-construction" => [
                ...
                "Tous mes murs, toits, sols sont isolés en plus des éléments porteurs",
            ...
            "Gestion de l'énergie" => [
                ...
                "J'affiche un plan d'allumage (pour les équipements de cuisson)",
            ...
            "Entretien et propreté" => [
                "Quelles actions sont mises en place pour réduire l'usage de produits dangereux lié à l'entretien des locaux ?",
                "Mes produits d'entretien sont sans produits chimiques (eau ozonée, nettoyage vapeur sèche) et/ou plus de 80% de mes produits sont écolabellisées (Ecocert, Ecolabel Européen ou équivalent) ou faits maison",
            ...
            "Accès aux personnes en situation de handicap" => [
                ...
                "J'ai à disposition des fauteuils ou des canne-sièges",
                "Je n'ai rien entrepris en ce sens",
            ],
            "Inclusivité sociale" => [
