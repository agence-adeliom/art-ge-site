 ...
 */
final class Version20231110132336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE territoire (id INT AUTO_INCREMENT NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, zips JSON NOT NULL COMMENT \'(DC2Type:json)\', code VARCHAR(255) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, use_slug TINYINT(1) NOT NULL, is_public TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
