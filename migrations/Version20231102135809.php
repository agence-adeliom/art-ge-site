 ...
 */
final class Version20231102135809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE choice_typologie (id INT AUTO_INCREMENT NOT NULL, choice_id INT NOT NULL, typologie_id INT NOT NULL, restauration TINYINT(1) NOT NULL, green_space TINYINT(1) NOT NULL, ponderation INT NOT NULL, INDEX IDX_E498D929998666D1 (choice_id), INDEX IDX_E498D92942F4634A (typologie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE score (id INT AUTO_INCREMENT NOT NULL, reponse_id INT NOT NULL, thematique_id INT NOT NULL, points DOUBLE PRECISION NOT NULL COMMENT \'Somme des points obtenus\', total INT NOT NULL COMMENT \'Somme des points possible d\'\'obtenir\', INDEX IDX_32993751CF18BB82 (reponse_id), INDEX IDX_32993751476556AF (thematique_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
