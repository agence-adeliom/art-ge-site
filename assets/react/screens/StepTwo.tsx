...
const StepTwo = ({
  ...
  const iconBackground =
    'bg-secondary-50 group-hover:bg-tertiary-400 trans-default is-active:bg-primary-200';
  ...
  return (
    <>
      ...
      <div className="grid gap-6 grid-cols-2 mt-8">
        <ChoiceCard
          type="hostel"
          selectFunction={selectEl}
          etablissement={etablissement}
          className={cardClass}
          icon={{ iconSrc: Hotel, alt: 'Hotel', iconClass: iconBackground }}
        >
        ...
        <ChoiceCard
          ...
          icon={{
            iconSrc: Tent,
            alt: 'Location de vacance',
            iconClass: iconBackground,
          }}
        >
          <Text color="neutral-700" weight={400}>
            Une location de vacances (gîte et meublé…)
          </Text>
        </ChoiceCard>
        ...
        <ChoiceCard
          ...
          etablissement={etablissement}
          className={cardClass}
          icon={{ iconSrc: Tent, alt: 'Camping', iconClass: iconBackground }}
        >
          <Text color="neutral-700" weight={400}>
            Un camping ou un locatif de plein air
          </Text>
        </ChoiceCard>
        ...
        >
          <Text color="neutral-700" weight={400}>
            Hébergement insolite(bulles, cabanes, tiny house…)
          </Text>
        </ChoiceCard>
