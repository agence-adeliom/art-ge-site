                ...
                <div className="bg-primary-600">
                    <div className="container grid grid-cols-12 gap-6 items-center pt-20 pb-8">
                        ...
                        <div className="col-span-full md:col-span-4 bg-white p-10 h-fit">
                            ...
                            <ProgressBar percentage={window.resultats.reponsePercentage}></ProgressBar>
                ...
                <div className="bg-primary-50 relative">
                    ...
                    <div className="container relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
                        {window.resultats.scores.map((score: Score) => (
                            <ResultCard key={score.slug} percentage={score.percentage} title={score.name} chosenChoices={score.chosenChoices} notChosenChoices={score.notChosenChoices}></ResultCard>
                        ))}
                    </div>
