        ...
        <AnimatePresence>
            ...
            <div className="bg-primary-600">
                <div className="container grid grid-cols-12 gap-6 items-center pt-20 pb-8">
                    <div className="flex flex-col gap-4 col-span-full md:col-span-8">
                        ...
                        <Button iconSide='left' size={'lg'} variant="secondary" icon='fa-link'>Copier le lien</Button>
                    </div>
            ...
            <div className="bg-primary-50 relative">
                ...
                <div className="container relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <ResultCard percentage={resultPercentage} title="Conservation de la nature du site"></ResultCard>
