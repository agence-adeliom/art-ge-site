...
const ActorsScores = ({ scores } : {
    ...
    return (
        <div className="px-4 lg:px-10 max-lg:pr-0 py-12">
            ...
            <Text className="mt-4" size="sm" color="neutral-700">Vous trouverez ci-dessous le score global de l’ensemble des filtres sélectionnés pour chaque typologie de prestataire.</Text>
