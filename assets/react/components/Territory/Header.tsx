...
const Header = () => {
    return (
        <div className="w-full">
            <div className="print:bg-white bg-primary-600 print:pb-0 py-12 px-4 lg:px-10 w-full relative overflow-hidden">
                <Heading variant="display-3" weight={400} className="print:text-black text-white" >
                    ÉcoBoussole
                </Heading>
