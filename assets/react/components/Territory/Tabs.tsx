    ...
    return (
        <div className="py-12">
            ...
            <div className="w-full">
                <div className="lg:grid lg:grid-cols-3 relative w-full">
                    ...
                    <div  className="lg:hidden col-span-full flex border-b border-neutral-300 items-stretch overflow-x-auto">
                        <div onClick={(e) => {handleTab(e) }} data-index={0} className={`${mobileTabClass}`}>
                            <Text weight={500} className="uppercase pointer-events-none" color="neutral-700" onClick={e => e.stopPropagation()}>départements</Text>
                        ...
                        <div onClick={(e) => {handleTab(e) }} data-index={1} className={`${mobileTabClass}`}>
                            <Text weight={500} className="uppercase pointer-events-none" color="neutral-700" onClick={e => e.stopPropagation()}>offices de tourisme</Text>
                        ...
                        <div onClick={(e) => {handleTab(e) }} data-index={2} className={`${mobileTabClass}`}>
                            <Text weight={500} className="uppercase pointer-events-none" color="neutral-700" onClick={e => e.stopPropagation()}>répondants</Text>
